...
Для начала заберу прова на редактирование только у дочернего процесса. В такой
конфигурации программа представленная выше должна упасть с исключением ошибки
записи, ведь нужно будет сохранить код возврата, а вся память запрещена на
запись.
